...
@Configuration
@EnableOAuth2Client
public class F5OpenidConnectConfig {

    @Value("${f5.clientId}")
    private String clientId;

    @Value("${f5.clientSecret}")
    private String clientSecret;

    @Value("${f5.accessTokenUri}")
    private String accessTokenUri;

    @Value("${f5.userAuthorizationUri}")
    private String userAuthorizationUri;

    @Value("${f5.redirectUri}")
